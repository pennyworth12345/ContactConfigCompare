class CfgMusic
{
	...
	class C_EA_RadioBroadcast1
	{
		duration = 41.73;
		musicClass = "Action";
		sound[] = {"\A3\music_f_EPC\Music\C_EA_RadioBroadcast1.ogg", 1, 1};
	};
	class C_EA_RadioBroadcast2
	{
		duration = 37.7;
		musicClass = "Action";
		sound[] = {"\A3\music_f_EPC\Music\C_EA_RadioBroadcast2.ogg", 1, 1};
	};
	class C_EA_RadioMusic1
	{
		duration = 52.22;
		musicClass = "Action";
		sound[] = {"\A3\music_f_EPC\Music\C_EA_RadioMusic1.ogg", 1, 1};
	};
	class C_EA_RadioMusic2
	{
		duration = 72.01;
		musicClass = "Action";
		sound[] = {"\A3\music_f_EPC\Music\C_EA_RadioMusic2.ogg", 1, 1};
	};
	class Defcon
	{
		duration = 193.23;
		sound[] = {"A3\Missions_F_EPA\data\music\defcon.ogg", 1.77828, 1};
	};
	...
	{
		duration = 207.05;
		sound[] = {"A3\Missions_F_EPA\data\music\fallout.ogg", 1.77828, 1};
	};
	class LeadTrack01_F
	{
		duration = 162.8;
	...
	{
		duration = 198;
		sound[] = {"A3\Missions_F_EPA\data\music\mad.ogg", 1, 1};
	};
	...
	{
		duration = 151.46;
		sound[] = {"A3\Missions_F_EPA\data\music\radio_music.ogg", 1, 1};
	};
	class RadioAmbient1
	{
		duration = 17.4;
	...
	{
		duration = 233.64;
		sound[] = {"A3\Missions_F_EPA\data\music\skynet.ogg", 1, 1};
	};
	...
	{
		duration = 194.88;
		sound[] = {"A3\Missions_F_EPA\data\music\wasteland.ogg", 1.77828, 1};
	};
};
