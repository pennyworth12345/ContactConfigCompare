class RscCustomInfoTransportFeedPrimaryGunner: RscCustomInfoUAVFeed
{
	idd = 317;
	...
	scriptName = "RscCustomInfoTransportFeedPrimaryGunner";
	scriptPath = "IGUI";
	class controls
	{
		class CameraPictureSingleView: RscPicture
		{
			...
			idc = 102;
			text = "#(argb,512,512,1)r2t(transportPipViewPrimaryGunner,1.0)";
