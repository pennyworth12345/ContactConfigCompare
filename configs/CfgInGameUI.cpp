class CfgInGameUI
{
	...
	class Cursor
	{
		...
		colorBackground[] = {"(profilenamespace getvariable ['IGUI_BCG_RGB_R',0])", "(profilenamespace getvariable ['IGUI_BCG_RGB_G',1])", "(profilenamespace getvariable ['IGUI_BCG_RGB_B',1])", "(profilenamespace getvariable ['IGUI_BCG_RGB_A',0.8])"};
		colorLocked[] = {1, 0, 0, 1};
		customMark = "\a3\UI_F_Contact\Data\RscMapControl\customMark_ca.paa";
	...
	class IslandMap
	{
		...
		colorCivilian[] = {"(missionnamespace getvariable ['Map_BLUFOR_R',profilenamespace getvariable ['Map_BLUFOR_R',0]])", "(missionnamespace getvariable ['Map_BLUFOR_G',profilenamespace getvariable ['Map_BLUFOR_G',0]])", "(missionnamespace getvariable ['Map_BLUFOR_B',profilenamespace getvariable ['Map_BLUFOR_B',1]])", "(missionnamespace getvariable ['Map_BLUFOR_A',profilenamespace getvariable ['Map_BLUFOR_A',1]])"};
		colorDetectorSync[] = {0, 1, 0, 1};
		colorDragging[] = {0.8, 0.8, 0.8, 1};
		colorEnemy[] = {"(missionnamespace getvariable ['Map_OPFOR_R',profilenamespace getvariable ['Map_OPFOR_R',1]])", "(missionnamespace getvariable ['Map_OPFOR_G',profilenamespace getvariable ['Map_OPFOR_G',0]])", "(missionnamespace getvariable ['Map_OPFOR_B',profilenamespace getvariable ['Map_OPFOR_B',0]])", "(missionnamespace getvariable ['Map_OPFOR_A',profilenamespace getvariable ['Map_OPFOR_A',1]])"};
		colorExplosive[] = {1, 0, 0, 1};
		colorExposureEnemy[] = {1, 0.2, 0.2, 0.5};
		colorExposureUnknown[] = {0.8, 0.8, 0.2, 0.5};
		colorFriendly[] = {"(missionnamespace getvariable ['Map_Independent_R',profilenamespace getvariable ['Map_Independent_R',0]])", "(missionnamespace getvariable ['Map_Independent_G',profilenamespace getvariable ['Map_Independent_G',1]])", "(missionnamespace getvariable ['Map_Independent_B',profilenamespace getvariable ['Map_Independent_B',0]])", "(missionnamespace getvariable ['Map_Independent_A',profilenamespace getvariable ['Map_Independent_A',1]])"};
		...
		colorNeutral[] = {"(missionnamespace getvariable ['Map_Civilian_R',profilenamespace getvariable ['Map_Civilian_R',1]])", "(missionnamespace getvariable ['Map_Civilian_G',profilenamespace getvariable ['Map_Civilian_G',1]])", "(missionnamespace getvariable ['Map_Civilian_B',profilenamespace getvariable ['Map_Civilian_B',1]])", "(missionnamespace getvariable ['Map_Civilian_A',profilenamespace getvariable ['Map_Civilian_A',1]])"};
		...
		colorSync[] = {0, 0, 1, 1};
		colorUnknown[] = {"(missionnamespace getvariable ['Map_Unknown_R',profilenamespace getvariable ['Map_Unknown_R',1]])", "(missionnamespace getvariable ['Map_Unknown_G',profilenamespace getvariable ['Map_Unknown_G',1]])", "(missionnamespace getvariable ['Map_Unknown_B',profilenamespace getvariable ['Map_Unknown_B',0]])", "(missionnamespace getvariable ['Map_Unknown_A',profilenamespace getvariable ['Map_Unknown_A',1]])"};
		cursorLineWidth = 0;
		iconCamera = "\A3\ui_f\data\igui\cfg\islandmap\iconCamera_ca.paa";
		iconCheckpoint = "#(argb,8,8,3)color(1,1,1,1)";
		iconPlayer = "\a3\UI_F_Contact\Data\CfgIngameUI\IslandMap\iconPlayer_ca.paa";
