class CfgMagazines
{
	...
	{
		author = "Bohemia Interactive";
		displayName = "5.8 mm 100Rnd Hex Mag";
	...
	{
		author = "Bohemia Interactive";
		displayName = "6.5 mm 100Rnd Tracer Black Mag";
		hiddenSelectionsTextures[] = {"\A3\Weapons_F_EPB\Rifles\MX_Black\Data\XMX_lmg_Black_co.paa"};
	...
	{
		author = "Bohemia Interactive";
		displayName = "6.5 mm 100Rnd Tracer Khaki Mag";
		hiddenSelectionsTextures[] = {"\A3\Weapons_F_Exp\Rifles\MX\Data\XMX_LMG_khk_co.paa"};
	...
	class 100Rnd_65x39_caseless_mag: CA_Magazine
	{
		...
		displayName = "6.5 mm 100Rnd Sand Mag";
	...
	{
		author = "Bohemia Interactive";
		displayName = "5.56 mm 150Rnd Green Mag";
		hiddenSelections[] = {"Camo"};
	...
	{
		author = "Bohemia Interactive";
		displayName = "5.56 mm 150Rnd Tracer (Red) Green Mag";
		displayNameShort = "Tracer";
	...
	class 2Rnd_12Gauge_Slug: 2Rnd_12Gauge_Pellets
	{
		...
		author = "Bohemia Interactive";
		descriptionShort = "Slug";
		displayName = "12 Gauge 2Rnd Slug";
		displayNameShort = "Slug";
	...
	class 30Rnd_556x45_Stanag_Sand_Tracer_Red: 30Rnd_556x45_Stanag_Sand
	{
		ammo = "B_556x45_Ball_Tracer_Red";
		author = "Bohemia Interactive";
		descriptionShort = "Caliber: 5.56x45 mm STANAG Tracers - Red<br />Rounds: 30<br />Used in: TRG-20, TRG-21/EGLM, Mk20/C/EGLM, SDAR, SPAR-16/S";
	...
	class 30Rnd_556x45_Stanag_Sand_Tracer_Yellow: 30Rnd_556x45_Stanag_Sand_Tracer_Red
	{
		ammo = "B_556x45_Ball_Tracer_Yellow";
		author = "Bohemia Interactive";
		descriptionShort = "Caliber: 5.56x45 mm STANAG Tracers - Yellow<br />Rounds: 30<br />Used in: TRG-20, TRG-21/EGLM, Mk20/C/EGLM, SDAR, SPAR-16/S";
	...
	class 30Rnd_580x42_Mag_F: CA_Magazine
	{
		...
		author = "Bohemia Interactive";
		count = 30;
		descriptionShort = "Caliber: 5.8x42 mm<br />Rounds: 30<br />Used in: CAR-95, CAR-95-1, CAR-95 GL";
	...
	class 30Rnd_65x39_caseless_mag: CA_Magazine
	{
		...
		displayName = "6.5 mm 30Rnd Sand Mag";
		hiddenSelections[] = {"camo"};
	...
	{
		author = "Bohemia Interactive";
		displayName = "6.5 mm 30Rnd Promet Tracer Mag";
		displayNameShort = "Tracer";
	...
	class 30Rnd_762x39_Mag_F: CA_Magazine
	{
		...
		displayName = "7.62 mm 30Rnd AKM Reload Tracer (Yellow) Mag";
		initSpeed = 715;
		lastRoundsTracer = 4;
		mass = 10;
	...
	{
		author = "Bohemia Interactive";
		displayName = "7.62 mm 30Rnd AKM Tracer (Yellow) Mag";
		displayNameShort = "Tracer";
		lastRoundsTracer = 30;
	...
	{
		author = "Bohemia Interactive";
		displayName = "7.62 mm 75Rnd AKM Tracer Mag";
	...
	class IEDLandBig_Remote_Mag: IEDUrbanBig_Remote_Mag
	{
		...
		picture = "\A3\Weapons_F\Data\UI\gear_IED_large_dugin_CA.paa";
	};
	...
	class IEDUrbanSmall_Remote_Mag: DemoCharge_Remote_Mag
	{
		...
		picture = "\A3\Weapons_F\Data\UI\gear_IED_small_urban_CA.paa";
	};
	...
	class magazine_Missile_s750_x4: magazine_Missile_mim145_x4
	{
		...
		descriptionShort = "Rhea Surface-to-Air Missile (S-750)";
		displayName = "Rhea AA";
		displayNameShort = "SAM LR";
	};
	class magazine_Missiles_Cruise_01_Cluster_x18: magazine_Missiles_Cruise_01_x18
	{
		...
		author = "Bohemia Interactive";
		descriptionShort = "Long-range, datalink guided, surface-to-surface missile with cluster munitions";
	...
	class magazine_Missiles_Cruise_01_x18: VehicleMagazine
	{
		...
		author = "Bohemia Interactive";
		count = 18;
		descriptionShort = "Long-range, datalink guided, surface-to-surface missile with high-explosive warhead";
		displayName = "Cruise Missile HE";
		displayNameShort = "VCM HE";
		initSpeed = 12;
	...
	{
		author = "Bohemia Interactive";
		descriptionShort = "Type: IR Strobe<br />Faction: Spetsnaz<br />Rounds: 1";
		displayName = "IR Grenade [Spetsnaz]";
	};
	...
	class PylonMissile_1Rnd_BombCluster_01_F: PylonMissile_1Rnd_Bomb_04_F
	{
		ammo = "BombCluster_01_Ammo_F";
		descriptionShort = "750lb, laser-guided cluster bomb";
		displayName = "CBU-85 Cluster x1";
		displayNameShort = "Cluster Bomb";
		hardpoints[] = {"B_BOMB_PYLON", "B_GBU12", "I_GBU12"};
		mass = 340;
	...
	class PylonMissile_1Rnd_BombCluster_02_cap_F: PylonMissile_1Rnd_BombCluster_02_F
	{
		...
		hardpoints[] = {"O_BOMB_PYLON", "O_KAB250_BOMB"};
		mass = 500;
	};
			...
			class Plane_Fighter_02
			{
				...
				class Draw
				{
					class BackgroundGroup
					{
						...
						class Background
						{
							points[] = {{{{0.135, 0.04}, 1}, {{0.165, 0.04}, 1}, {{0.165, 0.11}, 1}, {{0.135, 0.11}, 1}}};
							type = "polygon";
						};
					};
					class Default
					{
						...
						class Shape
						{
							points[] = {{{0.164, 0.135385}, 1}, {{0.164, 0.115692}, 1}, {{0.16, 0.110769}, 1}, {{0.16, 0.0492308}, 1}, {{0.14, 0.0492308}, 1}, {{0.14, 0.110769}, 1}, {{0.136, 0.115692}, 1}, {{0.136, 0.135385}, 1}, {{0.164, 0.135385}, 1}, {}, {{0.154, 0.0492308}, 1}, {{0.154, 0.0418461}, 1}, {}, {{0.146, 0.0492308}, 1}, {{0.146, 0.0418461}, 1}};
							type = "line";
							width = 4;
						};
					};
	...
	{
		count = 1;
		hardpoints[] = {"B_HARM_INT", "I_HARM_INT"};
		initSpeed = 0;
		initSpeedY = -25;
		initSpeedZ = 0;
				...
				class Draw
				{
					class Default
					{
						...
						class Missile1
						{
							...
							class Shape
							{
								points[] = {{"Center", {0, -0.0184615}, 1}, {"Center", {0.0075, -0.0159877}, 1}, {"Center", {0.01299, -0.00923077}, 1}, {"Center", {0.015, 0}, 1}, {"Center", {0.01299, 0.00923077}, 1}, {"Center", {0.0075, 0.0159877}, 1}, {"Center", {0, 0.0184615}, 1}, {"Center", {-0.0075, 0.0159877}, 1}, {"Center", {-0.01299, 0.00923077}, 1}, {"Center", {-0.015, 0}, 1}, {"Center", {-0.01299, -0.00923077}, 1}, {"Center", {-0.0075, -0.0159877}, 1}, {"Center", {0, -0.0184615}, 1}, {}, {"Center", {0.0106066, -0.0130543}, 1}, {"Center", {0.0212132, -0.0261086}, 1}, {}, {"Center", {0.0106066, 0.0130543}, 1}, {"Center", {0.0212132, 0.0261086}, 1}, {}, {"Center", {-0.0106066, 0.0130543}, 1}, {"Center", {-0.0212132, 0.0261086}, 1}, {}, {"Center", {-0.0106066, -0.0130543}, 1}, {"Center", {-0.0212132, -0.0261086}, 1}, {}};
								type = "line";
								width = 4;
							};
						};
						class Missile2
						{
							...
							class Shape
							{
								points[] = {{"Center2", {0, -0.0184615}, 1}, {"Center2", {0.0075, -0.0159877}, 1}, {"Center2", {0.01299, -0.00923077}, 1}, {"Center2", {0.015, 0}, 1}, {"Center2", {0.01299, 0.00923077}, 1}, {"Center2", {0.0075, 0.0159877}, 1}, {"Center2", {0, 0.0184615}, 1}, {"Center2", {-0.0075, 0.0159877}, 1}, {"Center2", {-0.01299, 0.00923077}, 1}, {"Center2", {-0.015, 0}, 1}, {"Center2", {-0.01299, -0.00923077}, 1}, {"Center2", {-0.0075, -0.0159877}, 1}, {"Center2", {0, -0.0184615}, 1}, {}, {"Center2", {0.0106066, -0.0130543}, 1}, {"Center2", {0.0212132, -0.0261086}, 1}, {}, {"Center2", {0.0106066, 0.0130543}, 1}, {"Center2", {0.0212132, 0.0261086}, 1}, {}, {"Center2", {-0.0106066, 0.0130543}, 1}, {"Center2", {-0.0212132, 0.0261086}, 1}, {}, {"Center2", {-0.0106066, -0.0130543}, 1}, {"Center2", {-0.0212132, -0.0261086}, 1}, {}};
								type = "line";
								width = 4;
							};
						};
					...
					class Selected: Default
					{
						...
						class Missile1: Missile1
						{
							class Background
							{
								points[] = {{{"Center", 1, {0, 0}, 1}, {"Center", {0.0106066, -0.0130543}, 1}, {"Center", {0.015, 8.06979e-010}, 1}, {"Center", {0.0106066, 0.0130543}, 1}}, {{"Center", 1, {0, 0}, 1}, {"Center", {0.0106066, 0.0130543}, 1}, {"Center", {-1.31134e-009, 0.0184615}, 1}, {"Center", {-0.0106066, 0.0130543}, 1}}, {{"Center", 1, {0, 0}, 1}, {"Center", {-0.0106066, 0.0130543}, 1}, {"Center", {-0.015, -2.20152e-010}, 1}, {"Center", {-0.0106066, -0.0130543}, 1}}, {{"Center", 1, {0, 0}, 1}, {"Center", {-0.0106066, -0.0130543}, 1}, {"Center", {2.62268e-009, -0.0184615}, 1}, {"Center", {0.0106066, -0.0130543}, 1}}};
								type = "polygon";
							};
							class Shape: Shape {};
						};
						class Missile2: Missile2
						{
							class Background
							{
								points[] = {{{"Center2", 1, {0, 0}, 1}, {"Center2", {0.0106066, -0.0130543}, 1}, {"Center2", {0.015, 8.06979e-010}, 1}, {"Center2", {0.0106066, 0.0130543}, 1}}, {{"Center2", 1, {0, 0}, 1}, {"Center2", {0.0106066, 0.0130543}, 1}, {"Center2", {-1.31134e-009, 0.0184615}, 1}, {"Center2", {-0.0106066, 0.0130543}, 1}}, {{"Center2", 1, {0, 0}, 1}, {"Center2", {-0.0106066, 0.0130543}, 1}, {"Center2", {-0.015, -2.20152e-010}, 1}, {"Center2", {-0.0106066, -0.0130543}, 1}}, {{"Center2", 1, {0, 0}, 1}, {"Center2", {-0.0106066, -0.0130543}, 1}, {"Center2", {2.62268e-009, -0.0184615}, 1}, {"Center2", {0.0106066, -0.0130543}, 1}}};
								type = "polygon";
							};
							class Shape: Shape {};
						};
	...
	class PylonRack_4Rnd_BombDemine_01_Dummy_F: PylonRack_4Rnd_BombDemine_01_F
	{
		...
		displayName = "Demining Charge (Dummy)";
		displayNameShort = "Dummy Charge";
	};
	class PylonRack_4Rnd_BombDemine_01_F: 4Rnd_Bomb_04_F
	{
		ammo = "BombDemine_01_Ammo_F";
		displayName = "Demining Charge";
		displayNameShort = "Demining Charge";
		hardpoints[] = {"ANTIMINE_DRONE_PYLON"};
		initSpeed = 0.1;
		mass = 10;
				...
				class Draw
				{
					class Default
					{
						...
						class Missile1
						{
							...
							class Shape
							{
								points[] = {{"Center1", {0, -0.00982906}, 1}, {"Center1", {0.005, -0.00851197}, 1}, {"Center1", {0.00866, -0.00491453}, 1}, {"Center1", {0.01, 0}, 1}, {"Center1", {0.00866, 0.00491453}, 1}, {"Center1", {0.005, 0.00851197}, 1}, {"Center1", {0, 0.00982906}, 1}, {"Center1", {-0.005, 0.00851197}, 1}, {"Center1", {-0.00866, 0.00491453}, 1}, {"Center1", {-0.01, 0}, 1}, {"Center1", {-0.00866, -0.00491453}, 1}, {"Center1", {-0.005, -0.00851197}, 1}, {"Center1", {0, -0.00982906}, 1}, {}, {"Center1", {0.00707107, -0.00695019}, 1}, {"Center1", {0.0141421, -0.0139004}, 1}, {}, {"Center1", {0.00707107, 0.00695019}, 1}, {"Center1", {0.0141421, 0.0139004}, 1}, {}, {"Center1", {-0.00707107, 0.00695019}, 1}, {"Center1", {-0.0141421, 0.0139004}, 1}, {}, {"Center1", {-0.00707107, -0.00695019}, 1}, {"Center1", {-0.0141421, -0.0139004}, 1}, {}};
								type = "line";
								width = 4;
							};
						};
						...
						class Missile3
						{
							...
							class Shape
							{
								points[] = {{"Center3", {0, -0.00982906}, 1}, {"Center3", {0.005, -0.00851197}, 1}, {"Center3", {0.00866, -0.00491453}, 1}, {"Center3", {0.01, 0}, 1}, {"Center3", {0.00866, 0.00491453}, 1}, {"Center3", {0.005, 0.00851197}, 1}, {"Center3", {0, 0.00982906}, 1}, {"Center3", {-0.005, 0.00851197}, 1}, {"Center3", {-0.00866, 0.00491453}, 1}, {"Center3", {-0.01, 0}, 1}, {"Center3", {-0.00866, -0.00491453}, 1}, {"Center3", {-0.005, -0.00851197}, 1}, {"Center3", {0, -0.00982906}, 1}, {}, {"Center3", {0.00707107, -0.00695019}, 1}, {"Center3", {0.0141421, -0.0139004}, 1}, {}, {"Center3", {0.00707107, 0.00695019}, 1}, {"Center3", {0.0141421, 0.0139004}, 1}, {}, {"Center3", {-0.00707107, 0.00695019}, 1}, {"Center3", {-0.0141421, 0.0139004}, 1}, {}, {"Center3", {-0.00707107, -0.00695019}, 1}, {"Center3", {-0.0141421, -0.0139004}, 1}, {}};
								type = "line";
								width = 4;
							};
						};
						class Missile4
						{
							...
							class Shape
							{
								points[] = {{"Center4", {0, -0.00982906}, 1}, {"Center4", {0.005, -0.00851197}, 1}, {"Center4", {0.00866, -0.00491453}, 1}, {"Center4", {0.01, 0}, 1}, {"Center4", {0.00866, 0.00491453}, 1}, {"Center4", {0.005, 0.00851197}, 1}, {"Center4", {0, 0.00982906}, 1}, {"Center4", {-0.005, 0.00851197}, 1}, {"Center4", {-0.00866, 0.00491453}, 1}, {"Center4", {-0.01, 0}, 1}, {"Center4", {-0.00866, -0.00491453}, 1}, {"Center4", {-0.005, -0.00851197}, 1}, {"Center4", {0, -0.00982906}, 1}, {}, {"Center4", {0.00707107, -0.00695019}, 1}, {"Center4", {0.0141421, -0.0139004}, 1}, {}, {"Center4", {0.00707107, 0.00695019}, 1}, {"Center4", {0.0141421, 0.0139004}, 1}, {}, {"Center4", {-0.00707107, 0.00695019}, 1}, {"Center4", {-0.0141421, 0.0139004}, 1}, {}, {"Center4", {-0.00707107, -0.00695019}, 1}, {"Center4", {-0.0141421, -0.0139004}, 1}, {}};
								type = "line";
								width = 4;
							};
						};
					...
					class Selected: Default
					{
						...
						class Missile1: Missile1
						{
							class Background
							{
								points[] = {{{"Center1", 1, {0, 0}, 1}, {"Center1", {0.00707107, -0.00695019}, 1}, {"Center1", {0.01, 4.29642e-010}, 1}, {"Center1", {0.00707107, 0.00695019}, 1}}, {{"Center1", 1, {0, 0}, 1}, {"Center1", {0.00707107, 0.00695019}, 1}, {"Center1", {-8.74228e-010, 0.00982906}, 1}, {"Center1", {-0.00707107, 0.00695019}, 1}}, {{"Center1", 1, {0, 0}, 1}, {"Center1", {-0.00707107, 0.00695019}, 1}, {"Center1", {-0.01, -1.1721e-010}, 1}, {"Center1", {-0.00707107, -0.00695019}, 1}}, {{"Center1", 1, {0, 0}, 1}, {"Center1", {-0.00707107, -0.00695019}, 1}, {"Center1", {1.74846e-009, -0.00982906}, 1}, {"Center1", {0.00707107, -0.00695019}, 1}}};
								type = "polygon";
							};
							class Shape: Shape {};
						};
						...
						class Missile3: Missile3
						{
							class Background
							{
								points[] = {{{"Center3", 1, {0, 0}, 1}, {"Center3", {0.00707107, -0.00695019}, 1}, {"Center3", {0.01, 4.29642e-010}, 1}, {"Center3", {0.00707107, 0.00695019}, 1}}, {{"Center3", 1, {0, 0}, 1}, {"Center3", {0.00707107, 0.00695019}, 1}, {"Center3", {-8.74228e-010, 0.00982906}, 1}, {"Center3", {-0.00707107, 0.00695019}, 1}}, {{"Center3", 1, {0, 0}, 1}, {"Center3", {-0.00707107, 0.00695019}, 1}, {"Center3", {-0.01, -1.1721e-010}, 1}, {"Center3", {-0.00707107, -0.00695019}, 1}}, {{"Center3", 1, {0, 0}, 1}, {"Center3", {-0.00707107, -0.00695019}, 1}, {"Center3", {1.74846e-009, -0.00982906}, 1}, {"Center3", {0.00707107, -0.00695019}, 1}}};
								type = "polygon";
							};
							class Shape: Shape {};
						};
						class Missile4: Missile4
						{
							class Background
							{
								points[] = {{{"Center4", 1, {0, 0}, 1}, {"Center4", {0.00707107, -0.00695019}, 1}, {"Center4", {0.01, 4.29642e-010}, 1}, {"Center4", {0.00707107, 0.00695019}, 1}}, {{"Center4", 1, {0, 0}, 1}, {"Center4", {0.00707107, 0.00695019}, 1}, {"Center4", {-8.74228e-010, 0.00982906}, 1}, {"Center4", {-0.00707107, 0.00695019}, 1}}, {{"Center4", 1, {0, 0}, 1}, {"Center4", {-0.00707107, 0.00695019}, 1}, {"Center4", {-0.01, -1.1721e-010}, 1}, {"Center4", {-0.00707107, -0.00695019}, 1}}, {{"Center4", 1, {0, 0}, 1}, {"Center4", {-0.00707107, -0.00695019}, 1}, {"Center4", {1.74846e-009, -0.00982906}, 1}, {"Center4", {0.00707107, -0.00695019}, 1}}};
								type = "polygon";
							};
							class Shape: Shape {};
						};
	...
	class PylonRack_Missile_HARM_x1: magazine_Missile_HARM_x1
	{
		count = 1;
		ejectSpeed[] = {1, 0, 0};
		hardpoints[] = {"B_HARM_RAIL", "I_HARM_RAIL"};
	...
	class TrainingMine_Mag: APERSMine_Range_Mag
	{
		...
		class Library
		{
			libTextDesc = "This dummy training mine is used to train and demonstrate usage of mines in a non-lethal manner. It uses a small flag and pyrotechnic charge to indicate activation. Even though this device is safe to use in most settings, it is not a toy and should be handled with care!";
		};
	};
	...
	class Vorona_HE: Vorona_HEAT
	{
		ammo = "M_Vorona_HE";
		author = "Bohemia Interactive";
		descriptionShort = "Type: 9M135 HE Missile<br />Rounds: 1<br />Used in: 9M135 Vorona";
	...
	class Vorona_HEAT: CA_LauncherMagazine
	{
		...
		author = "Bohemia Interactive";
		count = 1;
		descriptionShort = "Type: 9M135 HEAT Missile<br />Rounds: 1<br />Used in: 9M135 Vorona";
